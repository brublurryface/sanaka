...
- the complete 2,521-item media library;
...
| Media attachments | 2,521 | Historical library; not safe to treat as unused |
...
The 2,521 media attachments must not be classified as unused from this audit. Old theme content, Revolution Slider, plugin tables, pages, or unregistered custom post types may still reference them.
