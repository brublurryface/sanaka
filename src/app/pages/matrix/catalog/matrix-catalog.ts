...
export class MatrixCatalog {
  readonly upcomingExperiments: readonly UpcomingExperiment[] = [
    { number: '02', translationKey: 'matrix.catalog.upcoming.signals' },
    { number: '03', translationKey: 'matrix.catalog.upcoming.observables' },
    { number: '04', translationKey: 'matrix.catalog.upcoming.lifecycle' },
  ];
}
